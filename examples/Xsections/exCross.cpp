...
namespace nusquids{
  ...
  double LinearCrossSections::SingleDifferentialCrossSection(double E1, double E2, NeutrinoFlavor flavor, NeutrinoType neutype, Current current, Target target) const {
    if (E2 > E1)
      return 0.0;
    else if (E2 < 0)
      return 0.0;
    else
      return (TotalCrossSection(E1,flavor,neutype,current,target)/(E1/units.GeV))*(2.*E2/E1);
  }
